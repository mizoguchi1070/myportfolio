		...
		<div class="navigation">
			...
			<nav id="nav">
				<ul class="right-nav">
					...
					<li class="nav-list"><a href="<?php get_site_url() ?>/works">WORKS</a></li>
					<li class="nav-list"><a href="<?php get_site_url() ?>/about">ABOUT</a></li>
					<li class="nav-list"><a href="#">SKILL</a></li>
					<li class="nav-list"><a href="<?php get_home_url() ?>/#service">SERVICE</a></li>
					<li class="nav-list"><a href="<?php get_site_url() ?>/contact">CONTACT</a></li>
				</ul>
			</nav>
